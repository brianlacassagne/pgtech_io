...
public class ResponseController : ControllerBase
{
    ...
    {
        response.IdSolicitationProperty = solicitationId;
    ...
    [HttpGet]
    public async Task<List<Response?>> GetByInteractionId()
    {
    ...
    [HttpPut("id/{id:int}")]
    public async Task<bool> Put([FromBody] Response response, [FromRoute] int id)
    {
